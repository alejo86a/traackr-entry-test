...
This  These modified names should only use first names and last names from the original N names.  However, the new list and the old list should not share any full names.
...
. Our backend is written in PHP + Node.js, and our frontend is written in
  JavaScript. We prefer you submit the coding test in either PHP or JavaScript
  (Node.js). We recommend you choose the language you are the most comfortable
  with.
...
. It should be easy for others to compile and execute your submission. Build
  tools (phing, gulp, grunt, webpack etc) can come in very handy for this.
...
* Your build file and/or instructions on how to build your program.
